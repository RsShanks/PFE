...
if __name__ == "__main__":
    ...
    df_weekly = pd.read_csv("gdelt_weekly_finance_features.csv")  # Chargement direct pour accélérer les tests
    ...
    # 4. Sauvegarder
    df_final.to_csv("gdelt_weekly_finance_features_with_returns.csv", index=False)
