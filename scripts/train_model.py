...
def add_market_data(df_features, ticker, start="2006-01-01"):
    ...
    market_weekly = close.resample('W-MON').last().pct_change().to_frame(name='weekly_return')
    ...
    final = df_features.merge(market_weekly[['Date', 'target_return']], 
                             left_on="week", right_on="Date", how="left")
